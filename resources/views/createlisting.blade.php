...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">Create New Ticket<a href="/dashboard" class="btn btn-info btn-md float-right">Go back</a></div>
            ...
            <div class="col-md-12">
              ...
              <option value="{{$listing->user_id}}">{{$listing->assigned_to}}</option>
              @endforeach
              </select>
            </div>
            </div>
